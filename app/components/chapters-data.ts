...
export const books: Book[] = [
  ...
  },
  {
    ...
    chapters: [
      { id: "fuselageWings", title: "Fuselage, Wings and Stabilizing Surfaces", questionCount: 0 },
      { id: "basicHydraulics", title: "Basic Hydraulics", questionCount: 0 },
      ...
      { id: "aircraftBrakes", title: "Aircraft Brakes", questionCount: 0 },
      ...
      { id: "poweredFlyingControls", title: "Powered Flying Controls", questionCount: 0 },
      { id: "aircraftPneumaticSystems", title: "Aircraft Pneumatic Systems", questionCount: 0 },
      { id: "pressurizationSystems", title: "Pressurization Systems", questionCount: 0 },
      { id: "iceRainProtection", title: "Ice and Rain Protection", questionCount: 0 },
      { id: "aircraftOxygenEquipment", title: "Aircraft Oxygen Equipment", questionCount: 0 },
      ...
      { id: "aircraftFuelSystems", title: "Aircraft Fuel Systems", questionCount: 0 },
    ],
  },
  {
  ...
  },
  {
    ...
    chapters: [
      ...
      { id: "pistonPropellers", title: "Piston Engines - Propellers", questionCount: 0 },
      { id: "gasTurbineIntro", title: "Gas Turbines - Introduction", questionCount: 0 },
      { id: "gasTurbineAirInlets", title: "Gas Turbines - Air Inlets", questionCount: 0 },
      { id: "gasTurbineCompressors", title: "Gas Turbines - Compressors", questionCount: 0 },
      { id: "gasTurbineCombustion", title: "Gas Turbines - Combustion Chambers", questionCount: 0 },
      { id: "gasTurbineAssembly", title: "Gas Turbines - The Turbine Assembly", questionCount: 0 },
      { id: "gasTurbineExhaust", title: "Gas Turbines - The Exhaust System", questionCount: 0 },
      { id: "gasTurbineLubrication", title: "Gas Turbines - Lubrication", questionCount: 0 },
      { id: "gasTurbineThrust", title: "Gas Turbines - Thrust", questionCount: 0 },
      { id: "gasTurbineReverseThrust", title: "Gas Turbines - Reverse Thrust", questionCount: 0 },
      { id: "gasTurbineGearboxes", title: "Gas Turbines - Gearboxes and Accessory Drives", questionCount: 0 },
      { id: "gasTurbineIgnition", title: "Gas Turbines - Ignition Systems", questionCount: 0 },
      { id: "gasTurbineAPU", title: "Gas Turbines - Auxiliary Power Units and Engine Starting", questionCount: 0 },
      { id: "gasTurbineFuels", title: "Gas Turbines - Fuels", questionCount: 0 },
      { id: "gasTurbineFuelSystems", title: "Gas Turbines - Fuel Systems", questionCount: 0 },
      { id: "gasTurbineBleedAir", title: "Gas Turbines - Bleed Air", questionCount: 0 },
      { id: "powerplantRevision", title: "Revision Questions", questionCount: 0 },
    ],
  },
]
